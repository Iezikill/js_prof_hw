...
class Validator {
  constructor(form) {
    ...
    this.errors = {
      name: 'Имя доджно содержать только буквы',
      phone: 'Телефон должен быть записан в формате +7(000)000-0000',
      email: 'E-mail должен быть записан в формате mail@mail.ru, my.mail@mail.ru или my-mail@mail.ru'
    };
